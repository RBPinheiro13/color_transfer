...
title(['CT_{Moy}Sequentiel, t =',num2str(t1),'s'])
xlabel(['Distance =',num2str(moy_seq)])

subplot(232)
imshow(uint8(img_fin2));
title(['CT_{Moy}Minimal, t =',num2str(t2),'s'])
xlabel(['Distance =',num2str(moy_mat)])

subplot(233)
imshow(uint8(img_fin3));
title(['CT_{Moy}Sequentiel + 1 Iteration, t =',num2str(t3),'s'])
xlabel(['Distance =',num2str(moy_seq_mat)])

subplot(234)
imshow(uint8(img_fin4));
title(['CT_{Hist}Sequentiel, t =',num2str(t4),'s'])
...
title(['CT_{Hist}Sequent + 1 Iteration, t =',num2str(t6),'s'])
