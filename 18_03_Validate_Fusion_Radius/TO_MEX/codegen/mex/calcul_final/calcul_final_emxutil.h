/*
 * calcul_final_emxutil.h
 *
 * Code generation for function 'calcul_final_emxutil'
 *
 */

#ifndef CALCUL_FINAL_EMXUTIL_H
#define CALCUL_FINAL_EMXUTIL_H
...
/* End of code generation (calcul_final_emxutil.h) */
