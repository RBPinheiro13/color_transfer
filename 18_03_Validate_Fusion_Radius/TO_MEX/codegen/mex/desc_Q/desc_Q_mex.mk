...
SRC_FILES =  \
	...
	norm.c \
	warning.c \
	_coder_desc_Q_info.c \
	_coder_desc_Q_api.c \
	_coder_desc_Q_mex.c \
	desc_Q_emxutil.c

MEX_FILE_NAME_WO_EXT = desc_Q_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\desc_Q"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\desc_Q/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\desc_Q/%.cpp
	$(CC) $(CPPFLAGS) "$<"
