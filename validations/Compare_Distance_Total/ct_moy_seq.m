function [ img,corresp,R_t,G_t,B_t ] = ct_moy_seq(R_s,G_s,B_s, numlabels_source,R_t,G_t,B_t, labels_target, numlabels_target,sp_limit)
...
for pos_target = 1:numlabels_target
    ...
    for pos_source = 1:numlabels_source
        ...
        V_comp = (R_t(pos_target)-R_s(pos_source))^2+(G_t(pos_target)-G_s(pos_source))^2+(B_t(pos_target)-B_s(pos_source))^2;
