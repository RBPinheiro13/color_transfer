...
MAKEFILE = distance2_mex.mk

include distance2_mex.mki
...
MEX_FILE_NAME_WO_EXT = distance2_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\distance2"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\distance2/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\distance2/%.cpp
	$(CC) $(CPPFLAGS) "$<"
